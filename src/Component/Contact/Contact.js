...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_tabrej98756', 'template_j78h2wu', formRef.current, 'UPQDbc5tyb-BM7XGr')
            .then((result) => {
                setSuccess(true)
            }, (error) => {
                setError(true)
    ...
    return (
        ...
        <motion.div className='contact' ref={ref} variants={variants} initial="initial" whileInView="animate">
            ...
            <motion.div className='texttt-container' variants={variants} >
                <motion.h1 variants={variants}>Let's work together</motion.h1>
                <motion.div className='item' variants={variants} >
                    <h2 >Mail</h2 >
                    <span  >tabrezquadir6@gmail.com</span>
                </motion.div>
                <motion.div className='item' variants={variants} >
                    <h2>Adresss</h2>
            ...
            <div className='form-container'>
                ...
                >
                    ...
                    <p style={{color:"green"}}>{success && "😊 Success Your Message has been Sent 😊"}</p>
                </motion.form>
            </div>
